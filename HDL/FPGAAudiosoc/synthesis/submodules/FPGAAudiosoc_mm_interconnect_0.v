...
module FPGAAudiosoc_mm_interconnect_0 (
		...
		output wire [2:0]  I2S_0_ram_address,                              //                                I2S_0_ram.address
		...
		output wire [4:0]  I2S_0_timing_address,                           //                             I2S_0_timing.address
	...
	wire   [18:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> I2S_0_ram_agent:cp_channel
	...
	wire   [18:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> usb_irq_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> usb_gpx_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_011_src_channel;                                                            // cmd_mux_011:src_channel -> usb_rst_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> hex_digits_pio_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> key_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_016_src_channel;                                                            // cmd_mux_016:src_channel -> song_0_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_017_src_channel;                                                            // cmd_mux_017:src_channel -> spi_0_spi_control_port_agent:cp_channel
	...
	wire          i2s_0_timing_agent_rp_valid;                                                        // I2S_0_timing_agent:rp_valid -> router_020:sink_valid
	wire   [89:0] i2s_0_timing_agent_rp_data;                                                         // I2S_0_timing_agent:rp_data -> router_020:sink_data
	wire          i2s_0_timing_agent_rp_ready;                                                        // router_020:sink_ready -> I2S_0_timing_agent:rp_ready
	wire          i2s_0_timing_agent_rp_startofpacket;                                                // I2S_0_timing_agent:rp_startofpacket -> router_020:sink_startofpacket
	wire          i2s_0_timing_agent_rp_endofpacket;                                                  // I2S_0_timing_agent:rp_endofpacket -> router_020:sink_endofpacket
	...
	wire   [18:0] i2s_0_timing_burst_adapter_source0_channel;                                         // I2S_0_timing_burst_adapter:source0_channel -> I2S_0_timing_agent:cp_channel
	...
	wire          router_020_src_valid;                                                               // router_020:src_valid -> I2S_0_timing_rsp_width_adapter:in_valid
	wire   [89:0] router_020_src_data;                                                                // router_020:src_data -> I2S_0_timing_rsp_width_adapter:in_data
	wire          router_020_src_ready;                                                               // I2S_0_timing_rsp_width_adapter:in_ready -> router_020:src_ready
	wire   [18:0] router_020_src_channel;                                                             // router_020:src_channel -> I2S_0_timing_rsp_width_adapter:in_channel
	wire          router_020_src_startofpacket;                                                       // router_020:src_startofpacket -> I2S_0_timing_rsp_width_adapter:in_startofpacket
	wire          router_020_src_endofpacket;                                                         // router_020:src_endofpacket -> I2S_0_timing_rsp_width_adapter:in_endofpacket
	wire          i2s_0_timing_rsp_width_adapter_src_valid;                                           // I2S_0_timing_rsp_width_adapter:out_valid -> rsp_demux_018:sink_valid
	wire  [107:0] i2s_0_timing_rsp_width_adapter_src_data;                                            // I2S_0_timing_rsp_width_adapter:out_data -> rsp_demux_018:sink_data
	wire          i2s_0_timing_rsp_width_adapter_src_ready;                                           // rsp_demux_018:sink_ready -> I2S_0_timing_rsp_width_adapter:out_ready
	wire   [18:0] i2s_0_timing_rsp_width_adapter_src_channel;                                         // I2S_0_timing_rsp_width_adapter:out_channel -> rsp_demux_018:sink_channel
	wire          i2s_0_timing_rsp_width_adapter_src_startofpacket;                                   // I2S_0_timing_rsp_width_adapter:out_startofpacket -> rsp_demux_018:sink_startofpacket
	wire          i2s_0_timing_rsp_width_adapter_src_endofpacket;                                     // I2S_0_timing_rsp_width_adapter:out_endofpacket -> rsp_demux_018:sink_endofpacket
	...
	wire          cmd_mux_018_src_valid;                                                              // cmd_mux_018:src_valid -> I2S_0_timing_cmd_width_adapter:in_valid
	wire  [107:0] cmd_mux_018_src_data;                                                               // cmd_mux_018:src_data -> I2S_0_timing_cmd_width_adapter:in_data
	wire          cmd_mux_018_src_ready;                                                              // I2S_0_timing_cmd_width_adapter:in_ready -> cmd_mux_018:src_ready
	wire   [18:0] cmd_mux_018_src_channel;                                                            // cmd_mux_018:src_channel -> I2S_0_timing_cmd_width_adapter:in_channel
	wire          cmd_mux_018_src_startofpacket;                                                      // cmd_mux_018:src_startofpacket -> I2S_0_timing_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_018_src_endofpacket;                                                        // cmd_mux_018:src_endofpacket -> I2S_0_timing_cmd_width_adapter:in_endofpacket
	...
	wire   [18:0] i2s_0_timing_cmd_width_adapter_src_channel;                                         // I2S_0_timing_cmd_width_adapter:out_channel -> I2S_0_timing_burst_adapter:sink0_channel
	...
	wire          i2s_0_timing_agent_rdata_fifo_src_valid;                                            // I2S_0_timing_agent:rdata_fifo_src_valid -> avalon_st_adapter_018:in_0_valid
	wire   [17:0] i2s_0_timing_agent_rdata_fifo_src_data;                                             // I2S_0_timing_agent:rdata_fifo_src_data -> avalon_st_adapter_018:in_0_data
	wire          i2s_0_timing_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_018:in_0_ready -> I2S_0_timing_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_018_out_0_valid;                                                  // avalon_st_adapter_018:out_0_valid -> I2S_0_timing_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_018_out_0_data;                                                   // avalon_st_adapter_018:out_0_data -> I2S_0_timing_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_018_out_0_ready;                                                  // I2S_0_timing_agent:rdata_fifo_sink_ready -> avalon_st_adapter_018:out_0_ready
	wire    [0:0] avalon_st_adapter_018_out_0_error;                                                  // avalon_st_adapter_018:out_0_error -> I2S_0_timing_agent:rdata_fifo_sink_error
	...
	FPGAAudiosoc_mm_interconnect_0_router_009 router_020 (
